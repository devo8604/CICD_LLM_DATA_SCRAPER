...
class TokenizerCache:
    ...
    def prepare_prompt_with_context(self, system_message: str, user_message: str, max_context_tokens: int, max_output_tokens: int = 100) -> str:
        """
...
class PreTokenizer:
    ...
    def validate_request_size(self, prompt: str, max_context_tokens: int, expected_output_tokens: int = 100) -> tuple[bool, str]:
        """
    ...
    def prepare_and_validate(self, system_message: str, user_message: str, max_context_tokens: int, expected_output_tokens: int = 100) -> tuple[bool, str, str | None]:
        """
        ...
        """
        prompt = self.cache.prepare_prompt_with_context(system_message, user_message, max_context_tokens, expected_output_tokens)
